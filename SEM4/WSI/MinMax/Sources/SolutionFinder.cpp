...
int SolutionFinder::winningPossibilitiesHeurestic(const GameBoard &gameBoard){
    int numberofwins1 = gameBoard.winCounter(1);
    int numberofwins2 = gameBoard.winCounter(2);
    return 100*(numberofwins1-numberofwins2);
}

const int TWO1S = 100;
const int TWO2S = -100;
const int ONETWO = 0;
const int oneoneone = std::numeric_limits<int>::min();
const int twotwotwo = std::numeric_limits<int>::max();
const int oneblankoneone = 1000;
const int twoblanktwotwo = -1000;
const int oneblankblankone = 400;
const int twoblankblanktwo = -400;
const int oneoneoneone = std::numeric_limits<int>::max();
const int twotwotwotwo = std::numeric_limits<int>::min();
...
int SolutionFinder::case00(std::vector<int> sequence){
    ...
    if(count1==2) return oneblankblankone;
    else if(count2==2) return twoblankblanktwo;
...
int SolutionFinder::case0x(std::vector<int> sequence, int player, int shift){
    ...
    if(count1==3) return oneblankoneone;
    else if(count2==3) return twoblanktwotwo;
