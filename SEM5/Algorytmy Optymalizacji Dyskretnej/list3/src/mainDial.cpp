...
void printUsage(const std::string& appName) {
    ...
    std::cerr << "  -c <max_cost>          Maksymalna waga krawedzi (wymagane dla algorytmu Diala).\n";
...
void saveSSSPDistances(
    ...
    outFile << "c Wyniki dla algorytmu Diala, zrodlo: " << sourceNode << "\n";
...
int main(int argc, char* argv[]) {
    ...
    try {
        ...
        std::cout<<"MAX WEIGHT: "<<maxCost<<std::endl;
